...
- (void)defaultInit
{
    ...
    _progressTextFont           = [UIFont fontWithName:@"DINCondensed-Bold" size:20.0];
...
-(UIColor *)getBarColorWithIndex:(int)index{
    return [[_data objectAtIndex:index-1] valueForKey:kHACColor] ? [[_data objectAtIndex:index-1] valueForKey:kHACColor] : [UIColor blueColor];
}
...
-(UILabel *) setLabelWithFrame:(CGRect)frame text:(NSString*)text barColor:(UIColor *)barColor progress:(CGFloat)progess{
    ...
    switch ((int)_typeBar) {
        case HACBarType1:
            ...
            progressText.layer.borderWidth  = 0;
